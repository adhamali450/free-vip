...
const About = () => {
  ...
  const questions = {
    who: `احنا 3 شباب (منشية ناصر، الجيزة و المطرية) متابعين ابيو من 2018 (فانز واحد واحد). حاولنا نروح وراه كذا مرة في كذا حفلة لكن الفقر المضجع و شيل المواد كانوا ضدنا كل مرة. حلم حياتنا نسمع الميدلي لايف`,
